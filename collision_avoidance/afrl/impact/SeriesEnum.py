...
class SeriesEnum:
    ...
    def getName(self, type):
        ...
        if(type ==  36): return "GroundVehicleConfiguration"
        if(type ==  37): return "GroundVehicleState"
        if(type ==  38): return "WaterReport"
        if(type ==  39): return "WaterZone"
        if(type ==  40): return "SurfaceVehicleConfiguration"
        if(type ==  41): return "SurfaceVehicleState"
    ...
    def getType(self, name):
        ...
        if ( name == "GroundVehicleConfiguration"): return 36
        if ( name == "GroundVehicleState"): return 37
        if ( name == "WaterReport"): return 38
        if ( name == "WaterZone"): return 39
        if ( name == "SurfaceVehicleConfiguration"): return 40
        if ( name == "SurfaceVehicleState"): return 41
    ...
    def getInstance(self, type):
        ...
        if(type ==  36): return GroundVehicleConfiguration.GroundVehicleConfiguration()
        if(type ==  37): return GroundVehicleState.GroundVehicleState()
        if(type ==  38): return WaterReport.WaterReport()
        if(type ==  39): return WaterZone.WaterZone()
        if(type ==  40): return SurfaceVehicleConfiguration.SurfaceVehicleConfiguration()
        if(type ==  41): return SurfaceVehicleState.SurfaceVehicleState()
