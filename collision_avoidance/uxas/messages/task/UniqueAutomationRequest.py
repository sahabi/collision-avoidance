...
class UniqueAutomationRequest(LMCPObject.LMCPObject):
    ...
    def pack(self):
        ...
        buffer.append(struct.pack(">B", self.SandBoxRequest))
    ...
    def unpack(self, buffer, _pos):
        ...
        self.SandBoxRequest = struct.unpack_from(">B", buffer, _pos)[0]
        _pos += 1
    ...
    def toXMLMembersStr(self, ws):
        ...
        buf += ws + "</OriginalRequest>\n"
        buf += ws + "<SandBoxRequest>" + str(self.SandBoxRequest) + "</SandBoxRequest>\n"
