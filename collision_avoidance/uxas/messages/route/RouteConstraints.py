...
class RouteConstraints(LMCPObject.LMCPObject):
    ...
    def pack(self):
        ...
        buffer.append(struct.pack(">B", self.UseStartHeading))
        ...
        buffer.append(struct.pack(">B", self.UseEndHeading))
    ...
    def unpack(self, buffer, _pos):
        ...
        _pos += 4
        self.UseStartHeading = struct.unpack_from(">B", buffer, _pos)[0]
        _pos += 1
        _valid = struct.unpack_from("B", buffer, _pos )[0]
        _pos += 1
        if _valid:
        ...
        _pos += 4
        self.UseEndHeading = struct.unpack_from(">B", buffer, _pos)[0]
        _pos += 1
        return _pos
    ...
    def toXMLMembersStr(self, ws):
        ...
        buf += ws + "<UseStartHeading>" + str(self.UseStartHeading) + "</UseStartHeading>\n"
        buf += ws + "<EndLocation>\n"
        if self.EndLocation == None:
            buf += ws + "    <null/>\n"
        else:
        ...
        buf += ws + "<UseEndHeading>" + str(self.UseEndHeading) + "</UseEndHeading>\n"
